  ...
  return (
    <>
      <div className='relative w-full min-h-[100vh] overflow-hidden'>
        {/* ----------FilterSection-------- */}
        <div className='filter-sec-theme fixed top-16 z-20 flex flex-col items-center justify-center pt-2 xs:px-2 sm:px-5 lg:px-6 xl:px-8 gap-y-5 w-full min-h-[130px] duration-150'>
          <FilterSec
            search={search}
            setSearch={setSearch}
            setFilter={setFilter}
