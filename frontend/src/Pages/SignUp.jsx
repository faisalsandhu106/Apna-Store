...
const SignUp = () => {
    ...
    const handleSignUpForm = async (e) => {
        ...
        try {
            const url = 'https://apna-store-backend-navy.vercel.app/';
            ...
            const { success, message, jwtToken, firstname } = data;
            if (success) {
    ...
    return (
        <div className='background-image flex items-center justify-center xl:pt-24 w-full h-[100vh] overflow-hidden'>
            <form onSubmit={handleSignUpForm} className='flex flex-col items-center justify-center xs:px-4 xs:py-6 xs:w-[88%] md:w-[60%] lg:w-[45%] xl:w-[36%] text-[1em] tracking-[0.2px] rounded-md shadow-2xl text-gray-900 bg-[#F2F4F7]'>
                ...
                <div className='flex flex-col gap-y-4 mt-10 w-full'>
                    <div className='flex items-center justify-between w-full'>
                        <div className='flex flex-col gap-y-1 w-[47%]'>
                            <label htmlFor="" className='italic text-md font-medium text-gray-600'>First Name <span className='inline-block text-red-400'>*</span></label>
                            <input
                                type="text"
                                placeholder='Enter Your Firstname'
                                autoComplete='off'
                                name='firstname'
                                className='w-full px-3 py-[8px] text-[0.96em] rounded-md'
                                onChange={handleInputEvent}
                                value={signinfo.firstname} />
                        </div>
                        <div className='flex flex-col gap-y-1 w-[47%]'>
                            <label htmlFor="" className='italic text-md font-medium text-gray-600'>Last Name <span className='inline-block text-red-400'>*</span></label>
                            <input
                                type="text"
                    ...
                    <div className='flex flex-col gap-y-1'>
                        <label htmlFor="" className='italic text-md font-medium text-gray-600'>Address <span className='inline-block text-red-400'>*</span></label>
                        <input
                            type="text"
