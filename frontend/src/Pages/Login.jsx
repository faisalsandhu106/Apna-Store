...
const Login = () => {
    ...
    const handleLoginForm = async (e) => {
        ...
        try {
            const url = 'https://apna-store-mern-backend.vercel.app/auth/login';
        ...
        <div className='filter-sec-theme flex items-center justify-center py-28 w-full min-h-screen duration-150'>
            <form onSubmit={handleLoginForm} className='contact-form form-input ProductComp flex flex-col items-center justify-center py-8 xs:px-[10px] sm:px-[20px] lg:px-[20px] xs:w-[400px] sm:w-[340px] lg:w-[380px] rounded-md text-[0.98em] text-amber-50'>
                ...
                <div className='flex items-center justify-center xs:mt-3 md:mt-4 w-full'>
                    <button type='submit' className='w-full py-[7px] font-medium rounded-md bg-none hover:bg-none bg-[#db319d] hover:bg-[#a41570]'>
                        Login
                    </button>
                </div>
            </form>
