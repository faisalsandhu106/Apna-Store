...
const Login = () => {
    ...
    return (
        <div className='background-image flex items-center justify-center w-full h-[100vh] overflow-hidden'>
            <form onSubmit={handleLoginForm} className='flex flex-col items-center justify-center xs:px-4 xs:py-8 xs:w-[88%] md:w-[60%] lg:w-[45%] xl:w-[30%] text-[1em] tracking-[0.2px] rounded-md shadow-2xl text-gray-900 bg-[#F2F4F7]'>
                ...
                <div className='flex items-center justify-between xs:flex-col md:flex-row mt-10 xs:gap-y-1 w-full xs:text-[0.96em] md:text-[0.92em]'>
                    ...
                    <div className='flex items-center justify-center gap-x-2'>
                        ...
                        <NavLink to='/register' className='cursor-pointer underline hover:text-blue-600'>
                            Register
                        </NavLink>
                    </div>
                </div>
