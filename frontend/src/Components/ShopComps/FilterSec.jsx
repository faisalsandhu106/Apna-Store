...
const FilterSec = ({ search, setSearch, setFilter, category, setCategory, grid, setGrid, filterProduct }) => {
    ...
    return (
        <>
            ...
            <div className='grid xs:grid-cols-1 md:grid-cols-3 items-center gap-y-3 w-full h-auto duration-150'>
                ...
                <div className='flex xs:justify-between md:justify-end gap-x-7 w-full'>
                    ...
                    <select
                        ...
                        className='ProductComp p-1 rounded-md xs:text-[0.92em] sm:text-[0.9em]'>
            ...
            <div className='text-underLine flex items-center justify-center gap-x-4 py-1 w-full h-auto text-nowrap overflow-x-scroll scrollbar-hide'>
                {
                    CategoryList.map((item, index) => {
                        ...
                        return (
                            <button
                                ...
                                className={`p-0 capitalize cursor-pointer text-[0.82em] rounded-none font-medium duration-100 ${categoryProduct === category ? "active" : ''} bg-gradient-to-b from-none hover:bg-gradient-to-b from-none text-inherit`}>
                                {categoryProduct}
                            </button>
                        )
                    })
