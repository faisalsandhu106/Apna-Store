...
const AdminFilterProduct = ({ search, setSearch, category, setCategory, grid, setGrid, Allproduct }) => {
    ...
    return (
        <>
            ...
            <div className='text-underLine flex items-center xs:justify-center gap-x-4 mt-4 py-1 w-full h-auto text-nowrap overflow-x-scroll scrollbar-hide'>
                {
                    CategoryList.map((item, index) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-[0px] py-0 capitalize cursor-pointer text-[0.82em] rounded-none font-medium duration-100 ${categoryProduct === category ? "active" : ''} bg-gradient-to-b from-none hover:bg-gradient-to-b from-none text-inherit`}>
                                {categoryProduct}
                            </button>
                        )
                    })
