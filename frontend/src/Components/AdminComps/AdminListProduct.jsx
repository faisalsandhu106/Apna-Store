...
import { UseAdminContext } from '../ContextAPI/AdminContext';
      ...
      <div className='flex flex-col justify-start md:col-span-4 lg:col-span-3 gap-y-1 w-full text-[0.92em]'>
        ...
        <div className='flex items-center justify-start pt-4 gap-x-3 w-full'>
          <NavLink to={`/admin/allproducts/${_id}/edit`}>
            <button className='flex items-center justify-center gap-x-1 p-[0px] px-[7px] py-[6px] text-[0.86em] tracking-[0.1px] font-semibold hover:bg-[#A96AFC]'>
              <RxUpdate className='text-[1.1em]' />
              Update
            </button>
          </NavLink>
          <button onClick={() => deleteProduct(_id)} className='flex items-center justify-center gap-x-1 p-[0px] px-[7px] py-[6px] text-[0.86em] tracking-[0.1px] font-semibold bg-red-600 hover:bg-red-400 duration-100 bg-gradient-to-b from-none hover:bg-gradient-to-b from-none'>
